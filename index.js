...
app.use(express.static(__dirname + '/Convert URL to MarkDown_files'));
app.get('/', (req, res) => {
    res.sendFile(__dirname + '/index.html');
});
app.get('/get', (req, res) => {
  res.sendFile(__dirname + '/Convert URL to MarkDown.html');
});
app.get('/post', (req, res) => {
  res.sendFile(__dirname + '/Post URL to MarkDown.html');
});
...
app.listen(53112, () => {
    console.log('Server listening on port 53112');
});
